        ...
        public partial class DSPessoaRow : global::System.Data.DataRow
        {
            ...
            public string Nome
            {
                get
                {
                    ...
                    {
                        throw new global::System.Data.StrongTypingException("The value for column \'Nome\' in table \'DSPessoa\' is DBNull.", e);
                    }
                }
                set
                {
            ...
            public string Endereco
            {
                get
                {
                    ...
                    {
                        throw new global::System.Data.StrongTypingException("The value for column \'Endereco\' in table \'DSPessoa\' is DBNull.", e);
                    }
                }
                set
                {
            ...
            public string Cidade
            {
                get
                {
                    ...
                    {
                        throw new global::System.Data.StrongTypingException("The value for column \'Cidade\' in table \'DSPessoa\' is DBNull.", e);
                    }
                }
                set
                {
            ...
            public string Email
            {
                get
                {
                    ...
                    {
                        throw new global::System.Data.StrongTypingException("The value for column \'Email\' in table \'DSPessoa\' is DBNull.", e);
                    }
                }
                set
                {
            ...
            public System.DateTime DataNasc
            {
                get
                {
                    ...
                    {
                        throw new global::System.Data.StrongTypingException("The value for column \'DataNasc\' in table \'DSPessoa\' is DBNull.", e);
                    }
                }
                set
                {
            ...
            public string Telefone
            {
                get
                {
                    ...
                    {
                        throw new global::System.Data.StrongTypingException("The value for column \'Telefone\' in table \'DSPessoa\' is DBNull.", e);
                    }
                }
                set
                {
    ...
    public partial class DSPessoaTableAdapter : global::System.ComponentModel.Component
    {
        ...
        private void InitAdapter()
        {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DSPessoa] ([Nome], [Endereco], [Cidade], [Email], [DataNasc], " +
                "[Telefone]) VALUES (@Nome, @Endereco, @Cidade, @Email, @DataNasc, @Telefone);\r\nS" +
                "ELECT ID, Nome, Endereco, Cidade, Email, DataNasc, Telefone FROM DSPessoa WHERE " +
                "(ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DSPessoa] SET [Nome] = @Nome, [Endereco] = @Endereco, [Cidade] = @Cidade, [Email] = @Email, [DataNasc] = @DataNasc, [Telefone] = @Telefone WHERE (([ID] = @Original_ID) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Endereco = 1 AND [Endereco] IS NULL) OR ([Endereco] = @Original_Endereco)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_DataNasc = 1 AND [DataNasc] IS NULL) OR ([DataNasc] = @Original_DataNasc)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)));
SELECT ID, Nome, Endereco, Cidade, Email, DataNasc, Telefone FROM DSPessoa WHERE (ID = @ID)";
        ...
        private void InitConnection()
        {
            ...
            this._connection.ConnectionString = global::ProjetoAgendaDotNet.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nome, Endereco, Cidade, Email, DataNasc, Telefone FROM dbo.DSPessoa";
        ...
        public virtual int Fill(DataSetPessoa.DSPessoaDataTable dataTable)
        {
        ...
        public virtual DataSetPessoa.DSPessoaDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetPessoa.DSPessoaDataTable dataTable = new DataSetPessoa.DSPessoaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetPessoa.DSPessoaDataTable dataTable)
        {
        ...
        public virtual int Delete(int Original_ID, string Original_Nome, string Original_Endereco, string Original_Cidade, string Original_Email, global::System.Nullable<global::System.DateTime> Original_DataNasc, string Original_Telefone)
        {
        ...
        public virtual int Insert(string Nome, string Endereco, string Cidade, string Email, global::System.Nullable<global::System.DateTime> DataNasc, string Telefone)
        {
            if ((Nome == null))
            {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Endereco, string Cidade, string Email, global::System.Nullable<global::System.DateTime> DataNasc, string Telefone, int Original_ID, string Original_Nome, string Original_Endereco, string Original_Cidade, string Original_Email, global::System.Nullable<global::System.DateTime> Original_DataNasc, string Original_Telefone)
        {
            return this.Update(Nome, Endereco, Cidade, Email, DataNasc, Telefone, Original_ID, Original_Nome, Original_Endereco, Original_Cidade, Original_Email, Original_DataNasc, Original_Telefone, Original_ID);
        }
    }
