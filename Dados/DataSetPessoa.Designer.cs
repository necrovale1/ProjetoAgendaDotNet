...
namespace ProjetoAgendaDotNet.Dados.DataSetPessoaTableAdapters {
    ...
    public partial class DSPessoaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[DSPessoa] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Endereco = 1 AND [Endereco] IS NULL) OR ([Endereco] = @Original_Endereco)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)) AND ((@IsNull_DataNasc = 1 AND [DataNasc] IS NULL) OR ([DataNasc] = @Original_DataNasc)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[DSPessoa] ([Nome], [Email], [Endereco], [Telefone], [Cidade], [DataNasc]) VALUES (@Nome, @Email, @Endereco, @Telefone, @Cidade, @DataNasc);
SELECT ID, Nome, Email, Endereco, Telefone, Cidade, DataNasc FROM DSPessoa WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DSPessoa] SET [Nome] = @Nome, [Email] = @Email, [Endereco] = @Endereco, [Telefone] = @Telefone, [Cidade] = @Cidade, [DataNasc] = @DataNasc WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Endereco = 1 AND [Endereco] IS NULL) OR ([Endereco] = @Original_Endereco)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)) AND ((@IsNull_DataNasc = 1 AND [DataNasc] IS NULL) OR ([DataNasc] = @Original_DataNasc)));
SELECT ID, Nome, Email, Endereco, Telefone, Cidade, DataNasc FROM DSPessoa WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Email, Endereco, Telefone, Cidade, DataNasc FROM dbo.DSPessoa";
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_Email, string Original_Endereco, string Original_Telefone, string Original_Cidade, global::System.Nullable<global::System.DateTime> Original_DataNasc) {
        ...
        public virtual int Insert(string Nome, string Email, string Endereco, string Telefone, string Cidade, global::System.Nullable<global::System.DateTime> DataNasc) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Email, string Endereco, string Telefone, string Cidade, global::System.Nullable<global::System.DateTime> DataNasc, int Original_Id, string Original_Nome, string Original_Email, string Original_Endereco, string Original_Telefone, string Original_Cidade, global::System.Nullable<global::System.DateTime> Original_DataNasc, int ID) {
            if ((Nome == null)) {
